...
<div class="header">
	...
	<div class="nav">
	<ul>
		<li><a href="./loginout.jsp" data-localize="main.switchUsers">切换用户</li>
...
<div class="box">
	...
	<div class="button1" data-ls="offsetxin:0;delayin:1000;easingin:easeInOutQuart;scalexin:0.7;scaleyin:0.7;offsetxout:-800;durationout:1000;">
		<a href="#zuoTiInput" data-localize="main.answer">开始训练！</a>
	</div>
	...
	<div class="container">
			...
			<form action="servlet/getParam" method="post" onSubmit="return check()">
				...
				<li>
		            ...
		            <div class="sub">
		            	<input  class="rkmd-btn btn-lightBlue ripple-effect" type="submit" value="提交" id="submit" data-localize="submit">
...
$(function check(){
    ...
    $('form :input').blur(function(){
             ...
             //验证题目数量
             if( $(this).is('#numInfo') ){
                if( this.value=="" || this.value > 100 ||(this.value!="" && !/^\+?[1-9][0-9]*$/.test(this.value))){
            ...
            if( $(this).is('#maxNumInfo') ){
                ...
                if( this.value=="" || this.value > 1000 || this.value < 50||(this.value!="" && !/^\+?[1-9][0-9]*$/.test(this.value))){
             ...
             if( $(this).is('#minNumInfo') ){
             	var max = $('#maxNumInfo').value;
                if( this.value=="" || this.value < 1 ||this.value > 100||(this.value!="" && !/^\+?[1-9][0-9]*$/.test(this.value))){
