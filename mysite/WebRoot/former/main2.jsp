...
<div class="header">
	...
	<h2 style="font-size: 36px; float: left; ">四则运算在线答题系统</h2>
	

	<div class="nav">
	<ul>
		<li><a href="./loginout.jsp">切换用户</li>

		<li><a href="./history.jsp">查询历史题目</a></li>
...
<div class="box">
	...
	<div class="ls-l" data-ls="offsetxin:0;delayin:1000;easingin:easeInOutQuart;scalexin:0.7;scaleyin:0.7;offsetxout:-800;durationout:1000;">
		...
		<div class="text">
		<h2 class="l1">在线四则训练</h2>
		<h2 class="l2">无论何时何地都可以好好练习，你最好的选择！</h2>
	</div></div>
...
<div class ="zuoTiInput" id="zuoTiInput" >
	<div class="container">
			...
			<form action="servlet/getParam" method="post">
				<li>
					<label>题目数量：</label>
					<input type="text" name="num_of_formula" value="10">
				</li>
				<li>
					<label>算式最大值:</label>
...
$(function(){
    ...
    $('form :input').blur(function(){
            ...
            if( $(this).is('#maxNumInfo') ){
                if( this.value=="" || this.value.length > 1000 || this.value.length < 50){
             ...
             if( $(this).is('#numOperators') ){
                if( this.value=="" || this.value.length < 1 || this.value.length > 10){
